...
public class Bullet_FFrogg : Bullet
{
    void Update()
    {
    ...
    {
        SoundManager._instance.PlayEffect(DefineHelper.eEffectSound.FFroggShoot);
        _speed = speed;
        _dir = Vector3.right;
        _damage = damage;
    ...
    public override float Hit()
    {
        ...
        SoundManager._instance.PlayEffect(DefineHelper.eEffectSound.FFroggBoom);
        return _damage;
    }
}
